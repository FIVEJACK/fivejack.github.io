...
@section('contents')
	<div class="content">
		<h2 class="job-title">Junior UX Designer</h2>
		<p class="job-detail">
			Hello!
			<br><br>
			...
			- Minimum 1 Year working experience as a UX Designer<br>
			...
			- Advanced with using Adobe Photoshop & Illustrator<br>
			<br>
			<span class="sub-title">Preferred Qualifications</span><br>
			- Have knowledge in a/b test environment<br>
			- Have knowledge in working with HTML 5 & CSS 3<br>
			<br>
