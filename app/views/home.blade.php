...
function myFunction() {
    var x = document.getElementById("my_all_li");
    if (x.className === "all-li") {
...
<section id="home">
	<div class="wallpaper">
		...
		<img src='{{{ Config::get("constant.RESOURCE_URL") . "images/IMG_8387_1920.jpg" }}}' alt="fivejack team" align="center" class="wallpaper-image">
	...
	<div class="fivejack-culture">
		<div class="culture-agile">
			<img src='{{{ Config::get("constant.RESOURCE_URL") . "images/agile.png" }}}' alt="agile" class="culture-img">
			<p class="culture-font-agile">Agile</p>
		</div>
		<div class="culture-hardcore">
			<img src='{{{ Config::get("constant.RESOURCE_URL") . "images/hardcore-gamer.png" }}}' alt="hardcore gamer" class="culture-img">
			<p class="culture-font-hardcore">Hardcore Gamers</p>
		</div>
		<div class="culture-data">
			<img src='{{{ Config::get("constant.RESOURCE_URL") . "images/data-driven.png" }}}' alt="data driven" class="culture-img"> 
...
<br>
	<div class="career-container">
		<div class="roles-container">
			<div><p class="roles" id="se_menu" onclick="showJob('se')">Software Engineer</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="jux_menu" onclick="showJob('jux')">Junior UX Designer</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="sux_menu" onclick="showJob('sux')">Senior UX Designer</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="ie_menu" onclick="showJob('ie')">itemku Expert</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="cc_menu" onclick="showJob('cc')">Content Creator</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="sdm_menu" onclick="showJob('sdm')">Senior Digital Marketer</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="ggr_menu" onclick="showJob('ggr')">Global Game Researcher</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="finance_menu" onclick="showJob('finance')">Finance</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="so_menu" onclick="showJob('so')">Service Operator</p></div>
		...
		<div class="roles-container">
			<div><p class="roles" id="cs_menu" onclick="showJob('cs')">Customer Service</p></div>
