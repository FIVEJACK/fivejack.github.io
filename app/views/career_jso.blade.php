...
@section('contents')
	<div class="content">
		<h2 class="job-title">Junior Service Operator</h2>
		<p class="job-detail">
			<span class="sub-title">Job Description</span><br>
			Five Jack is looking for Junior Service Operator.<br>
			...
			<br>
			As the product growing, we prefer someone who has ability to handling itemku's payment system and monitoring on-going transactions.<br>
			...
			1. Diploma/Bachelor Degree in any Major<br>
			2. 1 year working experience in related field<br>
			...
			5. Can work independently or in a team and have strong initiative mind<br>
			<br>
			<br>
			...
			2. Basic english skill (written) is needed<br>
